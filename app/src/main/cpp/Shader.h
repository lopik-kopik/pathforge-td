...
public:
    ...
    /*!
     * Sets the per-model transform matrix in the shader.
     * @param modelMatrix sixteen floats, column major, defining the model transform.
     */
    void setModelMatrix(float *modelMatrix) const;

    /*!
     * Sets the color tint uniform in the shader.
     */
    void setColor(float r, float g, float b, float a) const;

    /*!
     * Sets the UV transform uniform for sprite animation.
     * x=offsetU, y=offsetV, z=scaleU, w=scaleV
     */
    void setUVTransform(float offsetU, float offsetV, float scaleU, float scaleV) const;
